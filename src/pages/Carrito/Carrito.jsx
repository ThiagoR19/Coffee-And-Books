  ...
  return (
    <section>
      <article id="productos">
        ...
        <div className='productos__div'>
          {productos.map((producto) => {
            return <div
              ...
              className="producto"
            >
              <img className='img-car' className='producto__img' src={cafeDefault} alt="Café por defecto" />
        ...
        <div className='productos__div'>
          <img className='img-car'className='productos__div-img' src={iconoWhatsapp} alt="Icono de Whatsapp" />
      ...
      <article id="producto">
        <div className='producto__div'>
          ...
          <img className='img-car'className='producto__div-img' src={cafeDefault} alt="" />
          <div className='producto__div-div'>
            <button className='producto__div-div-button'>
              <img className='img-car'className='producto__div-div-button-img' src={buttonMinus} alt="" />
            </button>
      ...
      <article id="resumen">
        ...
        <button className='resumen__button'>Finalizar Compra <img className='img-car'src={iconoBolsa} alt="" /></button>
        <div className='resumen__div'>
          <img className='img-car'className='resumen__div-img' src={iconoCheck} alt="" />
          <div className='resumen__div-div'>
